...
"""
Editor Agent – clarity, tone, flow; remove repetition; keep structure
"""
...
def read_draft(path="output/blog_draft.md"):
    if not os.path.exists(path):
        print("[!] blog_draft.md missing. Run writer_agent first.")
        return None
...
def run():
    ...
    out = "output/blog_edited.md"
    with open(out, "w", encoding="utf-8") as f:
        f.write(result)
    print(f"[✓] Edited blog saved to {out}")
